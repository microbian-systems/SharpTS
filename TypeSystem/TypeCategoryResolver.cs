...
public static class TypeCategoryResolver
{
    ...
    public static TypeCategory Classify(TypeInfo type) => type switch
    {
        ...
        TypeInfo.WeakRef => TypeCategory.WeakRef,
        TypeInfo.FinalizationRegistry => TypeCategory.FinalizationRegistry,
        ...
        TypeInfo.Iterable => TypeCategory.Iterable,
    ...
    public static bool HasBuiltInMemberValidation(TypeCategory category) => category switch
    {
        ...
        TypeCategory.WeakRef => true,
        TypeCategory.FinalizationRegistry => true,
